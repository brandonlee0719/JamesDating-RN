...
class Signup extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedAnuualIncomeId: null,
      // about me state
      aboutMe: null,
      aboutMeRelationship: null,
      // alchohole consuption state
      selectedAlcohole: null,
      selectedSmoke: '',
      selectedSmokeId: null,
      selectedFestiche: '',
      selectedFesticheId: null,
  ...
  componentDidUpdate = (prevProps, prevState) => {
    if (
      prevProps.dropDownList.lookingRelation !==
      this.state.lookingRelationShipArray
    ) {
      this.setState({
        lookingRelationShipArray: prevProps.dropDownList.lookingRelation,
      });
    }
    if (
      prevProps.dropDownList.personlity !== this.state.selectedPersonalityArray
    ) {
      this.setState({
        selectedPersonalityArray: prevProps.dropDownList.personlity,
      });
    }
    if (
      prevProps.dropDownList.qualities !== this.state.selectedQualitiesArray
    ) {
      this.setState({
        selectedQualitiesArray: prevProps.dropDownList.qualities,
      });
    }
    if (prevProps.dropDownList.hobbies !== this.state.selectedHobbyArray) {
      this.setState({
        selectedHobbyArray: prevProps.dropDownList.hobbies,
      });
    }
  };
  update(nextState) {
